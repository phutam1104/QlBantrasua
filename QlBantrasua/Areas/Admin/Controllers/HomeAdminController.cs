       ...
       // Tạo sản phẩm mới phương thức GET: Admin/Home/Create
        public ActionResult Create()
        {
          //  Để tạo dropdownList bên view
            var hangselected = new SelectList(db.Loai, "Maloai", "Tenloai");
        ...
        public ActionResult Edit(int id)
        {
            ...
            var hangselected = new SelectList(db.Loai, "Maloai", "Tenhang", dt.Maloai);
            ViewBag.Mahang = hangselected;
            var hdhselected = new SelectList(db.Loai, "Maloai", "Tenloai", dt.Maloai) ;
